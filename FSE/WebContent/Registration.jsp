...
*Password
<input required = "required" type = "password" name = "password" size = "15">
<br/>

*Re-enter Password
<input required = "required" type = "password" name = "passwordConfirm" size = "15">
<br/>

*Phone number
<input required = "required" type = "tel" name = "phone">
<br/>
...
*Date of Birth
<select required = "required" name="birthMonth">
...
<select required = "required" name="birthDay">
...
<select required = "required" name="birthYear">
